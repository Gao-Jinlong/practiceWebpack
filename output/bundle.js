...
/* harmony import */ var lodash_fp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
class IO {
  ...
  map(fn) {
    return new IO(lodash_fp__WEBPACK_IMPORTED_MODULE_1___default().flowRight(fn, this._value));
  }
}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  ...
  function getSumByCurriedFunctor() {
    ...
    const curriedFn = lodash__WEBPACK_IMPORTED_MODULE_0___default().curry(fp);
    const curriedFnSum = curriedFn(sum);
    const start = Date.now();
    for (i = 0; i < count; i++) {
...
/* harmony import */ var _compareMap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);


(0,_compareMap__WEBPACK_IMPORTED_MODULE_1__["default"])();
